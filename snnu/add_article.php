...
<form method="post" enctype="multipart/form-data" action='add_article.php'>
	<input type="hidden" name="action" value="update" /> id：<input
		type="text" name="id" id="id" size="40"><input type="button" value="获取数据" onclick="getData();"/><br><br>期号：<input
		type="text" name="no" id="no" size="40"><br>标题：<input
		type="text" name="title" id="title" size="40"><br> 简介：<input type="text" name="description" id="description"
